<div class="app-header header-shadow">
    <div class="app-header__logo">
        <div>
            <img src="{!! url('/resources/assets/images/logo.webp') !!}" style="width: 27%;" alt="">
        </div>
                ...
                <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left  ml-3 header-user-info">
                            <div class="widget-heading" style="text-align: center"> {!! strtoupper(explode('@',auth()->user()->username)[0]) !!}
                                <br>
                                <a href="{!! url('/logout') !!}"><i class="metismenu-icon pe-7s-power" style="font-size: 20px;color:black"></i></a> </div>
                         </div>
                    </div>
                </div>
            </div>
